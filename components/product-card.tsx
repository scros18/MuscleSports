...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Card className={`overflow-hidden hover:shadow-lg flex flex-col h-full group border hover:border-primary/30 ${animationClass}`}>
        ...
        <div className="relative aspect-square w-full overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
          ...
          {product.featured && (
            <div className="absolute top-2.5 right-2.5 z-10">
              <div className="relative backdrop-blur-sm bg-gradient-to-br from-blue-500/95 via-indigo-500/95 to-purple-500/95 text-white px-2.5 py-1 rounded-md shadow-lg border border-white/20 font-semibold text-[10px]">
